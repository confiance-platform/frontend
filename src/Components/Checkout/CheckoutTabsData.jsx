        ...
        <>
            <div className="mt-4">
                ...
                <div>
                    ...
                    <img src="/assets/images/checkbox-radio/logo1.png" className="w-30 h-30" alt="Visa" />
                    <span className="ms-2">
                                ...
                                <CardBody className="select-content">
                                    <FormGroup check className="position-relative">
                                        <Label check className="d-flex align-items-center">
                                            ...
                                            />
                                            <span className="d-flex align-items-center ms-2">
                    <img src="/assets/images/checkbox-radio/logo3.png" className="w-30 h-30" alt="PayPal" />
                    <span className="ms-2">
                    ...
                    <Row>
                        <Col xs={6} sm={2} className="mb-3">
                            <Card className="bg-light-dark b-r-10">
                                <img src="/assets/images/ecommerce/23.jpg" alt="product-img"
                                     className="img-fluid bg-light-dark b-r-10"/>
                            </Card>
                        </Col>
                        <Col xs={6} sm={2} className="mb-3">
                            <Card className="bg-light-dark b-r-10">
                                <img src="/assets/images/ecommerce/25.jpg" alt="product-img"
                                     className="img-fluid bg-light-dark b-r-10"/>
                            </Card>
                        </Col>
                        <Col xs={6} sm={2} className="mb-3 mt-sm-0">
                            <Card className="bg-light-dark b-r-10">
                                <img src="/assets/images/ecommerce/13.jpg" alt="product-img"
                                     className="img-fluid bg-light-dark b-r-10"/>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        <Col xs={12}>
                            <div className="text-center">
                                <div className="mb-3">
                                    <img src="/assets/images/form/done.gif" alt="form"/>
                                </div>
