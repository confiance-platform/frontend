                            ...
                            <Nav pills vertical className="step-status">
                                <NavItem>
                                    <NavLink
                                        ...
                                        onClick={() => toggleTab('1')}
                                    >
                                        <img src="../assets/images/checkbox-radio/logo1.png" className="w-35 h-35" alt="" />
                                ...
                                <NavItem>
                                    <NavLink
                                        ...
                                        onClick={() => toggleTab('2')}
                                    >
                                        <img src="../assets/images/checkbox-radio/logo2.png" className="w-35 h-35" alt="" />
                                        <span>Visa Card</span>
                                    </NavLink>
                                </NavItem>
                                <NavItem>
                                    <NavLink
                                        ...
                                        onClick={() => toggleTab('3')}
                                    >
                                        <img src="../assets/images/checkbox-radio/logo3.png" className="w-35 h-35" alt="" />
                                        <span>Paypal</span>
                                    </NavLink>
                                </NavItem>
                            </Nav>
