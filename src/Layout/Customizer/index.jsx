            ...
            >
                ...
                <div className="offcanvas-footer">
                    <div className="d-flex gap-2">
                        ...
                        <Link type="button" className="btn btn-success w-100"
                           to="/dashboard/portfolio">Dashboard</Link>
                    </div>
                    <div className="d-flex gap-2 mt-2">
                        <Link type="button" className="btn btn-primary w-100"
                           to="mailto:support@confiance.com">Support</Link>
                        <Link type="button" className="btn btn-dark w-100" to="/terms-condition">Terms</Link>
                    </div>
                </div>
            </div>
        </>
