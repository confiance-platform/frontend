export const avatarsData = [
    ...
    {
        header: "text-light-danger",
        className: "text-light-danger",
        code: `
    ...
    {
        header: "avtar radious",
        className: "avtar-radious",
        code: `
      <div class="d-flex gap-3 flex-wrap">
