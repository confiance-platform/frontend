export const initialCardData = [
    ...
    {
        id: 4,
        title: "Images/file folder",
        image: "/assets/images/icons/gallary.png",
        isStarred: true,
    },
...
export const initialrecentData = [
    ...
    {
        id: 2,
        icon: "/assets/images/icons/pdf.png",
    ...
    {
        id: 3,
        icon: "/assets/images/icons/folder.png",
    ...
    {
        id: 5,
        icon: "/assets/images/icons/zip.png",
    ...
    {
        id: 6,
        icon: "/assets/images/icons/gallary.png",
