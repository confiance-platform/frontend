                                ...
                                <div className="form-wizard-header">
                                    ...
                                    <ul className="vertica-wizard-steps">
                                        <li className={`${step >= 1 ? 'activated' : ''} ${step === 1 ? 'active' : ''}`}>
                                            <span className="wizard-steps"><i className="ti ti-users"></i></span>
                                        </li>
                                        <li className={`${step >= 2 ? 'activated' : ''} ${step === 2 ? 'active' : ''}`}>
                                            <span className="wizard-steps"><i className="ti ti-phone-plus"></i></span>
                                        </li>
                                        <li className={`${step >= 3 ? 'activated' : ''} ${step === 3 ? 'active' : ''}`}>
                                            <span className="wizard-steps"><i className="ti ti-info-circle"></i></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
