    ...
    return (
        <>
            <Container fluid>
                ...
                <Row className="m-1">
                    <Col xs={12}>
                        <h4 className="main-title">Switch</h4>
                      ...
                      <span>
                        <i className="ph-duotone  ph-cardholder f-s-16"></i>  Forms elements
                            ...
                            <li className="active">
                                <a href="#" className="f-s-14 f-w-500">Switch</a>
                            </li>
                        </ul>
                    </Col>
                </Row>
                    ...
                    <Col sm="6" xxl="4">
                        <Card className="equal-card">
                            ...
                            <CardBody className="main-switch main-switch-color">
                                <div className="switch-primary my-3">
                                    <input
                                        type="checkbox"
                                        id="check-001"
                                        className="toggle"
                                ...
                                <div className="switch-secondary my-3">
                                    <input
                                        type="checkbox"
                                        id="check-002"
                                        className="toggle"
                                ...
                                <div className="switch-danger swich-size my-3">
                                    <input
                                        type="checkbox"
                                        id="check-004"
                                        className="toggle"
